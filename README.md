...
- ⚡ My __technical skills__ include but not limited to: `React.js`, `JavaScript`, `CSS`, `Node.js`, `MongoDB`, `Agile (Jira/Scrum/Kanban)`, `Bootstrap`, `AWS`, `PostgreSQL`, `Docker`, `Jenkins`
- 🌱 I’m currently __learning__: `Java`
