...
- ⚡ My __technical skills__ include but not limited to: `React.js`, `JavaScript`, `CSS`, `Node.js`, `MongoDB`, `Agile (Jira/Scrum/Kanban)`, `Bootstrap` 
- 🌱 I’m currently __learning__: `MySQL`, `Docker & Kubernetes`, `AWS`, `PostgreSQL`
